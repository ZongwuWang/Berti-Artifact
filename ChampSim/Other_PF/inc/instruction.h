...
public:
  uint64_t instr_id, ip, fetch_producer, producer_id, translated_cycle,
    ...
    //   stall_end_cycle,
      stall_cycle,      // stall_end_cycle - stall_begin_cycle
      load_stall_begin_cycle,
      stall_begin_rob_occupancy; // Neelu: Adding to capture ROB occupancy at
                                 // stall start.
  ...
  uint8_t is_branch, is_memory, branch_taken, branch_mispredicted,
      ...
      retire_window_fellow_is_trouble, btb_miss = 0;
